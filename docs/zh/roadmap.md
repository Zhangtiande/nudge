...
[English](../en/roadmap.md) | [中文](roadmap.md)
...
- ✅ **建议缓存**（v0.4.2）：LRU+TTL 缓存，stale-while-revalidate 策略
  ...
  - 上下文变化自动失效
- ✅ **Bash popup 选择器**（v0.4.5）：支持 fzf/sk/peco/builtin 后端的多候选浏览
  - LLM 生成多候选建议
  - 高风险命令预览和确认
  - 通过环境变量配置
...
| Bash popup 选择器 | v0.4.5 | 支持选择器后端的多候选浏览 |

### 平台支持

| Shell | 手动模式 | 自动模式 | 错误诊断 | Popup |
|---|---|---|---|---|
| Zsh | ✅ v0.1.0 | ✅ v0.3.0 | ✅ v0.3.0 | ❌ |
| Bash | ✅ v0.1.0 | ❌ | 🎯 计划中 | ✅ v0.4.5 |
